...
Refer to the [openTofu guides](https://opentofu.org/docs/) or [official terraform guides](https://www.terraform.io/docs/index.html) for a general understanding of openTofu and full commands.
