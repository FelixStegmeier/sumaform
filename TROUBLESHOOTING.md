...
A: you can use [openTofu's taint command](https://opentofu.org/docs/cli/commands/taint.html) to mark a resource to be re-created during the next `tofu apply`. To get the correct name of the module and resource use `tofu state list`:
